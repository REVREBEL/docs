...
```json docs.json
{
  "navbar": {
    "links": [
      { "label": "Helpdesk", "href": "mailto:helpdesk@revrebel.io" }
    ],
    "primary": {
      "type": "button",
      "label": "Dashboard",
...
```json docs.json
{
  "footer": {
    "socials": {
      "instagram": "https://instagram.com/hello_revrebel",
      "github": "https://github.com/revrebel",
      "linkedin": "https://linkedin.com/company/revrebel",
      "website": "https://revrebel.io"
    }
  }
}
```
